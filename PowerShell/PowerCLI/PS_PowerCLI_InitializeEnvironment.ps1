...
$version = Get-PowerCLIVersion
$windowTitle = "VMware $productName {0}.{1} Release 3" -f $version.Major, $version.Minor
$host.ui.RawUI.WindowTitle = "$windowTitle"
...
Try	{
	...
	if ($promptForCEIP -and
		...
		$message = `
			...
			"that enables VMware to improve its products and services and to fix problems. " +
			"By choosing to participate in CEIP, you agree that VMware may collect technical information " +
			"about your use of VMware products and services on a regular basis. " +
		...
		# Save the response
		Set-PowerCLIConfiguration -Scope User -ParticipateInCEIP $participate -Confirm:$false | Out-Null
	}
} Catch {
	# Fail silently
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUlBlf/L2/+1ZliXpPQVgO50Do
# /x2gghmqMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# BgkqhkiG9w0BCQQxFgQUhnE9Ypix8wtG7GCHt4UFaPase1UwKgYKKwYBBAGCNwIB
# DDEcMBqhGIAWaHR0cDovL3d3dy52bXdhcmUuY29tLzANBgkqhkiG9w0BAQEFAASC
# AQDMRNpo4NNr5HK7fNroXjOivgphMvfZIRDMlfWQOF03LH2+4X+ePnD2xtzFUmCi
# S+BDVSb2oXBtQidTRBvyBMaLUnHNpGAtjJIHnZCaVIoBh7F68nMfz5NyPUvnqkq9
# UTkObmTJM25kBAVqZTDhNFRAXiZkAlqX0jHex1yl+XbOGPvLcqKEUifzv648sDzB
# TMCpYyOJuX9XzMD3vL9HAp01RjW27JjyLdyA69+if6qoW9VC/8HZrchZN5bL6Hrn
# dZ4bvoQ5GwxdVy8yQ0yG0RbMAfH1bnQ0O9gVsbpX/WS7ngRoXzisZMsY5aOcY9Ju
# Nul3B73+In7G0SWWjZkbXhxdoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgwggH0AgEB
...
# BgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE1MTEwMzExNDA1OFowIwYJKoZI
# hvcNAQkEMRYEFJKAQv2ScDnYRhHrELbhoEkbqHlsMA0GCSqGSIb3DQEBAQUABIIB
# AKIUifIYk/6RwzNnjgLjuTocxuK4MSUTieCIBC2Z/MnTm9jgNw55g8Ct5NYA4565
# t+sFM5NBkyCroqQo8sLinoXnWh0zrlWN/rWGA+r6vg2PV6eiGtBhsjHV8TOiqKV3
# ngMq1Ny32U6ZKpsQr/x6QEVS67TqGjduu+hEIchnFcqxYrcEIGL+mThYH04yhPrU
# pFDdoMyZReVzNpYsHh7a6PQLNjDqmBjmyxsLwpaoJH/XfSdGm7KL/u67gdvBfVR8
# 15dunnreJHHQoYtUpR+26rs9/skx5I0OPL5tjJNP/DyEXUWB8A7ISxGDHInJvkAI
# T2l3/i0CKbW9jbJe32ZtIvI=
