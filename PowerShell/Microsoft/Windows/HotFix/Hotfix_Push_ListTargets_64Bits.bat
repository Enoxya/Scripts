...
SET listeOrdinateursCibles=ListeOrdinateursCibles_64Bits.txt
...
SET KB=Windows6.1-KB2999226-x64.msu
...
psexec64 -s @%ListeOrdinateursCibles% wusa %repertoireCible%%KB% /passive /quiet /norestart
